...
<input class="{eq( $html_class, 'half' )|choose( 'box', 'halfbox' )}" type="text" size="70" name="{$attribute_base}_all2ecoupon_data_text_{$attribute.id}" value="{$data_text|wash( xhtml )}" />
{/let}
{/default}